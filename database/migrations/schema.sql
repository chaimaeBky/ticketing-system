...
DROP TYPE IF EXISTS sujet_ticket CASCADE;
...
-- Sujets possibles pour les tickets
CREATE TYPE sujet_ticket AS ENUM (
    'livraison',
    'paiement',
    'bug',
    'retour',
